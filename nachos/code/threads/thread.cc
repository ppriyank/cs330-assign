...
//----------------------------------------------------------------------
// machine->aliveprocesscount = 
int NachOSThread::aliveprocesscount = 0;
int NachOSThread::processcount = 0;
NachOSThread::NachOSThread(char* threadName)
{
    ...
    //Initialized the variables of the object with valid initial values
    num_of_instructions = 0;
    pid = ++processcount;
    ppid = (pid==1)?0:currentThread->getpid();
